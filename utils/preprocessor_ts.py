...
class PreprocessorTS(pl.LightningDataModule):
    def __init__(self) -> None:
        super().__init__()

    def load_data(self, tahun):
        bulan2id = {
            "Januari": 1,
            "Februari": 2,
            "Maret": 3,
    ...
    # Override setup Datamodule
    def setup(self, stage = None):
        x_train, y_train, x_test, y_test, scaler, train_set_scaled, test_set_scaled = self.preprocess()
